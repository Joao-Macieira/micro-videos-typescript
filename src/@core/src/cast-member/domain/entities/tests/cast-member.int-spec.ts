...
describe("CastMember Integration Tests", () => {
  describe("create method", () => {
    ...
    it("should a invalid cast member using type property", () => {
      expect(() => new CastMember({ name: 'test', type: null } as any)).containsErrorMessages(
        {
          type: [
            "type should not be empty",
            "type must be an instance of CastMemberType",
      ...
      expect(() => new CastMember({ name: 'test', type: 5 } as any)).containsErrorMessages({
  ...
  describe("update method", () => {
    ...
    it("should a invalid cast member using type property", () => {
      const castMember = CastMember.fake().anActor().build();
      expect(() => castMember.update('test', null)).containsErrorMessages({
        type: [
          "type should not be empty",
          "type must be an instance of CastMemberType",
        ],
      ...
      expect(() => castMember.update('test', 5 as any)).containsErrorMessages({
        type: ["type must be an instance of CastMemberType"],
      });
    });
