...
describe("Genre Integration Tests", () => {
  describe("create method", () => {
    ...
    it("should a invalid genre using categories_id property", () => {
      expect(
        () => new Genre({ name: 'test', categories_id: null } as any)
      ).containsErrorMessages({
        categories_id: [
          "categories_id should not be empty",
          "each value in categories_id must be an instance of CategoryId",
      ...
      expect(
        () => new Genre({ name: 'test', categories_id: undefined } as any)
      ).containsErrorMessages({
        categories_id: [
          "categories_id should not be empty",
          "each value in categories_id must be an instance of CategoryId",
      ...
      expect(
        () => new Genre({ name: 'test', categories_id: [] } as any)
      ).containsErrorMessages({
        categories_id: ["categories_id should not be empty"],
      });

      expect(
        () => new Genre({ name: 'test', categories_id: [1] } as any)
      ).containsErrorMessages({
        categories_id: [
          "each value in categories_id must be an instance of CategoryId",
        ],
      ...
      expect(
        () => new Genre({ name: 'test', categories_id: [categoryId, categoryId] } as any)
      ).containsErrorMessages({
