...
describe('CastMembersController (e2e)', () => {
  describe('/cast-members (POST)', () => {
    ...
    describe('should create a cast member', () => {
      ...
      let castMemberRepository: CastMemberRepository.Repository;
      beforeEach(async () => {
        castMemberRepository = app.app.get<CastMemberRepository.Repository>(
      ...
      test.each(arrange)(
        ...
        async ({ send_data, expected }) => {
          ...
          const castMemberCreated = await castMemberRepository.findById(id);
